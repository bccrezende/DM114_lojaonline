...
import br.inatel.lojaonline.models.AccessToken;
...
import br.inatel.lojaonline.util.WSConstants;
...
public class WebServiceClient {
    ...
    public static WebServiceResponse get(Context context, String host) {
        ...
        try {
            ...
            //Log.i("TRABALHO","" + webServiceResponse.getResponseCode());
    ...
    public static WebServiceResponse put(Context context,
                                           String host) {
        WebServiceResponse webServiceResponse = new WebServiceResponse();
        try {
            webServiceResponse = init(context, host,
...
//                    context.getString(R.string.pref_ws_default_password));
            ...
            if (conn.getResponseCode() == 200) {
                ...
                editor.putString(context.getString(R.string.pref_ws_access_token),
                        accessToken.getAccess_token());
                editor.putLong(context.getString(R.string.pref_ws_access_token_expiration),
